...
namespace HourlyRate.Migrations
{
    ...
    [Migration("20210529072618_PaidService")]
    partial class PaidService
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HourlyRate.Data.Models.PaidService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PaidServiceRealtyBooking", b =>
                {
                    b.Property<int>("BookingsId")
                        .HasColumnType("int");

                    b.Property<int>("PaidServicesId")
                        .HasColumnType("int");

                    b.HasKey("BookingsId", "PaidServicesId");

                    b.HasIndex("PaidServicesId");

                    b.ToTable("PaidServiceRealtyBooking");
                });

            modelBuilder.Entity("PaidServiceRealtyObject", b =>
                {
                    b.Property<int>("ObjectsId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ObjectsId", "PaidServicesId");

                    b.HasIndex("PaidServicesId");

                    b.ToTable("PaidServiceRealtyObject");
                });
            ...
            modelBuilder.Entity("PaidServiceRealtyBooking", b =>
                {
                    b.HasOne("HourlyRate.Data.Models.RealtyBooking", null)
                        .WithMany()
                        .HasForeignKey("BookingsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HourlyRate.Data.Models.PaidService", null)
                        .WithMany()
                        .HasForeignKey("PaidServicesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
